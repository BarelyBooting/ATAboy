...
The fork's build calls itself `0.6f3p7-palimpsest` and shows `v0.6f3p7 (fork)` in the setup screen (0.6f3p1 before items 6 to 15, 0.6f3p6 before 16 to 21), so it can't be mistaken for a stock v0.6f3.
